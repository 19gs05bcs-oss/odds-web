...
export const metadata = {
  title: "Open Matches — Live Fixture Odds",
  description:
    "Upcoming fixtures listed by kickoff with live odds, updated change-only from the feed. Pick a match to start a historical odds profile search.",
};
