...
export const metadata = {
  title: "Seasons — Multi-Season Odds Archive",
  description:
    "Browse every Flashscore season loaded into the OddsVig archive and jump straight into an odds profile search by competition.",
};
